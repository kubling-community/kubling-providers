...
`metadata__name`; cluster-scoped resources use `metadata__name`. The native
resource identity remains available as a unique key. This rule follows
discovery automatically and does not require listing resources in the provider
configuration.
